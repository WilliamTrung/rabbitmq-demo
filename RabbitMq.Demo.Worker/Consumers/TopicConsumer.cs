...
{
    public class TopicConsumer : ConsumerBase, IConsumer
    {
        public TopicConsumer(IRabbitMQProvider rabbitMQProvider, IServiceProvider serviceProvider) : base(rabbitMQProvider, serviceProvider)
        {
        }
